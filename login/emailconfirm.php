...
$student = fetchAll($db, 'student', ['id_student', mds($h)])->num_rows;
$teacher = fetchAll($db, 'teacher', ['id_teacher', mds($h)])->num_rows;
...
?>
    ...
    <body class="emailconfirm" id="emailconfirm">
        <div class="container">
            <h1>Confirmação de email realizada com sucesso!</h1>
            <p>O seu email foi confirmado com sucesso. <a href="../home-teacher.php">Clique aqui</a> para acessar a plataforma.</p>
        </div>
    </body>
    </html>
